...
export function GuestResults() {
  ...
  const handleDownload = () => {
    ...
    const blob = new Blob([JSON.stringify(watermarkedData, null, 2)], {
      type: "application/json",
    });
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = "brsr_sample_data.json";
    a.click();
    ...
    <>
      ...
      <main className="flex-1">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              >
                ...
                PDF Report
                <span className="absolute -top-2 -right-2 text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-amber-100 text-amber-700 border border-amber-200">PRO</span>
              </button>
              <a
          ...
          {/* Section C - LOCKED for free users */}
          ...
          {gaps && gaps.missing_mandatory.length > 0 && (
            <div className="mt-10 mb-8">
              ...
              {/* Mandatory Non-Core Gaps - LOCKED */}
              {(() => {
