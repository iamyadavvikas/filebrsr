            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 px-1 py-1">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-[11px] text-gray-500 font-medium">Select All</span>
                </label>
                {selected.size > 0 && (
                  <button
                    onClick={bulkDeleteReports}
                    disabled={bulkDeleting}
                    className="px-2 py-1 text-[11px] font-medium text-red-600 bg-red-50 hover:bg-red-100 rounded-md transition-colors flex items-center gap-1 disabled:opacity-50"
                  >
              ...
              {reports.map((report) => (
                ...
                >
                  ...
                  />
                  <Link href={`/platform/reports/${report.id}`} className="flex items-center gap-3 flex-1 min-w-0">
