...
const faqs = [
  ...
  { q: "Does it support BRSR filing?", a: "Yes. Upload any sustainability PDF and AI extracts all 337 BRSR datapoints (Essential + Leadership) in minutes. Includes gap analysis, scoring, XBRL generation, and multi-framework mapping (GRI, CDP, TCFD, SASB, plus ESRS under CSRD and IFRS S1/S2 under ISSB)." },
